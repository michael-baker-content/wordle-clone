...
/** @typedef {{ player:number[], dealer:number[], next:number, hidden:boolean, phase:Phase, round:number, handsWon:number, jokersBought?:number, strikes?:number, message:string }} State */
...
/** @param {State} state */
export function points(state) { return state.handsWon * 100 + score(state) - jokerSpend(state.jokersBought ?? 0) - (state.strikes ?? 0) * 100; }
/** @param {number} count */
